...
while cap.isOpened():
    ...
    if len(landmark_list) != 0:
      ...
      #  cv2.rectangle(img, (0, 380), (100, 480), (0, 255, 0), cv2.FILLED)
        cv2.rectangle(img, (0, 0), (700, 73), (245, 117, 16), -1)
        cv2.putText(img, str(int(count)), (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 1,
                    (255, 255, 255), 2, cv2.LINE_AA)
        
        #Show the pushup feedback 
        #qcv2.rectangle(img, (500, 0), (640, 40), (255, 255, 255), cv2.FILLED)
        cv2.putText(img, feedback, (60, 60 ), cv2.FONT_HERSHEY_SIMPLEX, 1,
                    (255, 255, 255), 2, cv2.LINE_AA)
